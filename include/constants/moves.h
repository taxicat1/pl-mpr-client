#ifndef MPR_CONSTANTS_MOVES_H
#define MPR_CONSTANTS_MOVES_H
...
#define GBA_VALID_MOVE_COUNT  MOVE_PSYCHO_BOOST
#define VALID_MOVE_COUNT      (MAX_MOVES - 1)

#endif /* MPR_CONSTANTS_MOVES_H */
