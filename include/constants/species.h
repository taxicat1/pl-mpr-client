#ifndef MPR_CONSTANTS_SPECIES_H
#define MPR_CONSTANTS_SPECIES_H
...
typedef enum {
	...
	NATIONAL_DEX_COUNT = SPECIES_ARCEUS,
	SPECIES_MAX = SPECIES_BAD_EGG,
	MAX_SPECIES = SPECIES_MAX
} Species;

#endif /* MPR_CONSTANTS_SPECIES_H */
