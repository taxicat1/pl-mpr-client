...
#define TEXT_COLOR(letter, shadow, bg) \
    ((TextColor)(((letter & TEXT_COLOR_MASK) << TEXT_COLOR_FG_SHIFT) | \
...
u8 Text_AddPrinter(const TextPrinterTemplate* printerTemplate, u32 renderDelay, TextPrinterCallback callback);
