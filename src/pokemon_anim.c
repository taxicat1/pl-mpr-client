...
static const u8 sNatureAnimSpeeds[NATURE_MAX] = {
	[NATURE_HARDY]    =  POKEANIMSPEED_FAST,
	[NATURE_LONELY]   =  POKEANIMSPEED_SLOW,
	[NATURE_BRAVE]    =  POKEANIMSPEED_FAST,
	[NATURE_ADAMANT]  =  POKEANIMSPEED_FAST,
	[NATURE_NAUGHTY]  =  POKEANIMSPEED_FAST,
	[NATURE_BOLD]     =  POKEANIMSPEED_MEDIUM,
	[NATURE_DOCILE]   =  POKEANIMSPEED_MEDIUM,
	[NATURE_RELAXED]  =  POKEANIMSPEED_MEDIUM,
	[NATURE_IMPISH]   =  POKEANIMSPEED_FAST,
	[NATURE_LAX]      =  POKEANIMSPEED_MEDIUM,
	[NATURE_TIMID]    =  POKEANIMSPEED_SLOW,
	[NATURE_HASTY]    =  POKEANIMSPEED_FAST,
	[NATURE_SERIOUS]  =  POKEANIMSPEED_MEDIUM,
	[NATURE_JOLLY]    =  POKEANIMSPEED_FAST,
	[NATURE_NAIVE]    =  POKEANIMSPEED_FAST,
	[NATURE_MODEST]   =  POKEANIMSPEED_SLOW,
	[NATURE_MILD]     =  POKEANIMSPEED_SLOW,
	[NATURE_QUIET]    =  POKEANIMSPEED_SLOW,
	[NATURE_BASHFUL]  =  POKEANIMSPEED_SLOW,
	[NATURE_RASH]     =  POKEANIMSPEED_MEDIUM,
	[NATURE_CALM]     =  POKEANIMSPEED_MEDIUM,
	[NATURE_GENTLE]   =  POKEANIMSPEED_SLOW,
	[NATURE_SASSY]    =  POKEANIMSPEED_MEDIUM,
	[NATURE_CAREFUL]  =  POKEANIMSPEED_SLOW,
	[NATURE_QUIRKY]   =  POKEANIMSPEED_MEDIUM
};
...
enum {
	...
	Y_NORMALIZATION_NEGATIVE_SCALE,
	Y_NORMALIZATION_OFF,
	Y_NORMALIZATION_ON,
	TRANSFORM_CURVE_SIN,
	TRANSFORM_CURVE_COS,
...
u8 PokemonAnim_GetSpeedFromNature(const u8 nature) {
	GF_ASSERT(nature < NATURE_MAX);
	return sNatureAnimSpeeds[nature];
}
...
void PokemonAnimManager_InitAnim(PokemonAnimManager* monAnimMan, PokemonSprite* monSprite, const PokemonAnimTemplate* animTemplate, u8 index) {
	...
	NarcID narc;
	if (gIsDiamondPearl) {
		narc = NARC_INDEX_DP_POKEANIME__POKE_ANM;
	} else {
		narc = NARC_INDEX_PL_POKEANIME__PL_POKE_ANM;
	}
	monAnimMan->anims[index].scriptData = NARC_AllocAtEndAndReadWholeMemberByIndexPair(narc, monAnimMan->anims[index].animNum, monAnimMan->heapID);
