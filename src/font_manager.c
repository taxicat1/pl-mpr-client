...
static void FontManager_LoadGlyphs(FontManager* fontManager, GlyphAccessMode glyphAccessMode, HeapID heapID);
...
static const u8 sGlyphShapes[][2] = {
	{ GLYPH_SHAPE_8x8,  GLYPH_SHAPE_8x16  },
	{ GLYPH_SHAPE_16x8, GLYPH_SHAPE_16x16 }
};
