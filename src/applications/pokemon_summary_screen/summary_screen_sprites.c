...
enum SpriteTemplateID {
	...
	PokemonSummaryScreen_Template_MonTypeIcon1,
	PokemonSummaryScreen_Template_MonTypeIcon2,
	
	PokemonSummaryScreen_Template_MoveTypeIcon1,
	PokemonSummaryScreen_Template_MoveTypeIcon2,
	PokemonSummaryScreen_Template_MoveTypeIcon3,
	PokemonSummaryScreen_Template_MoveTypeIcon4,
	PokemonSummaryScreen_Template_MoveTypeIcon5,
	
	PokemonSummaryScreen_Template_CategoryIcon,
	PokemonSummaryScreen_Template_MonIcon,
	PokemonSummaryScreen_Template_StatusIcon,
	
	PokemonSummaryScreen_Template_Sheen,
	
	PokemonSummaryScreen_Template_TabArrow,
	
	PokemonSummaryScreen_Template_TouchButtonEffect,
	
	PokemonSummaryScreen_Template_ConditionArrow,
	
	PokemonSummaryScreen_Template_AButton,
	
	PokemonSummaryScreen_Template_MarkingCircle,
	PokemonSummaryScreen_Template_MarkingTriangle,
	PokemonSummaryScreen_Template_MarkingSquare,
	PokemonSummaryScreen_Template_MarkingHeart,
	PokemonSummaryScreen_Template_MarkingStar,
	PokemonSummaryScreen_Template_MarkingDiamond,
	
	PokemonSummaryScreen_Template_ShinyPokerusCuredIcon,
	
	PokemonSummaryScreen_Template_ContestStatDot,
	
	PokemonSummaryScreen_Template_Ribbon1,
	PokemonSummaryScreen_Template_Ribbon2,
	PokemonSummaryScreen_Template_Ribbon3,
	PokemonSummaryScreen_Template_Ribbon4,
	PokemonSummaryScreen_Template_Ribbon5,
	PokemonSummaryScreen_Template_Ribbon6,
	PokemonSummaryScreen_Template_Ribbon7,
	PokemonSummaryScreen_Template_Ribbon8,
	PokemonSummaryScreen_Template_Ribbon9,
	PokemonSummaryScreen_Template_Ribbon10,
	PokemonSummaryScreen_Template_Ribbon11,
	PokemonSummaryScreen_Template_Ribbon12,
	
	PokemonSummaryScreen_Template_RibbonCursor,
...
void PokemonSummaryScreen_SetCaughtBallGfx(PokemonSummaryScreen* summaryScreen) {
	...
	SpriteSystem_ReplaceCharResObj(summaryScreen->spriteSys, summaryScreen->spriteMan, narc, ballMember, FALSE, 0);
	SpriteSystem_ReplacePlttResObj(summaryScreen->spriteSys, summaryScreen->spriteMan, narc, balls_0_NCLR + sBallIDToPaletteNum[summaryScreen->monData.caughtBall], FALSE, 6);
}
...
void PokemonSummaryScreen_SetMonIcon(PokemonSummaryScreen* summaryScreen) {
	...
	SpriteSystem_ReplaceCharResObj(summaryScreen->spriteSys, summaryScreen->spriteMan, narc, iconIndex, 0, 11);
	...
	Sprite_SetFlipMode(summaryScreen->sprites[SUMMARY_SPRITE_MON_ICON], (SpeciesData_GetSpeciesValue(summaryScreen->monData.species, SPECIES_DATA_FLIP_SPRITE) ^ 1));
}
...
void PokemonSummaryScreen_ShowMonIcon(PokemonSummaryScreen* summaryScreen) {
	...
	SpriteSystem_ReplacePlttResObj(summaryScreen->spriteSys, summaryScreen->spriteMan, narc, PokeIconPalettesFileIndex(), FALSE, 5);
...
static void SetRibbonSpriteGfx(PokemonSummaryScreen* summaryScreen, u8 ribbonID, u8 ribbonIndex) {
	...
	SpriteSystem_ReplaceCharResObj(summaryScreen->spriteSys, summaryScreen->spriteMan, narc, Ribbon_GetData(ribbonID, RIBBON_DATA_SPRITE_ID), 0, 26 + ribbonIndex);
...
void PokemonSummaryScreen_UpdateRibbonSprites(PokemonSummaryScreen* summaryScreen) {
	...
	SpriteSystem_ReplacePlttResObj(summaryScreen->spriteSys, summaryScreen->spriteMan, narc, ribbons_NCLR, FALSE, 5);
