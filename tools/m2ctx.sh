...
GCC=gcc
FLAGS="-E -P -dD -undef"
INCLUDES="-Iinclude -Ilib/include/NitroSDK -Ilib/include/NitroSystem -Ilib/include/MSL"
DEFINES="-D_NITRO -DLINK_PPWLOBBY -DNNS_FINALROM -DSDK_4M -DSDK_ARM9 -DSDK_CODE_ARM -DSDK_CW -DSDK_CW_FORCE_EXPORT_SUPPORT -DSDK_FINALROM -DSDK_TS"
